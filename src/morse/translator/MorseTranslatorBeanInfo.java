...
public class MorseTranslatorBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_amplitude = 0;
    private static final int PROPERTY_signalColor = 1;
    private static final int PROPERTY_speed = 2;
    private static final int PROPERTY_text = 3;
    private static final int PROPERTY_translateText = 4;
